// Taken from this issue in the docs describing how to show blog posts on the homepage which is what I want
// https://github.com/facebook/docusaurus/issues/4138
  ...
  return {
    ...
    contentLoaded: async function (params) {
      ...
      actions.addRoute({
        ...
        modules: {
          homePagePostsMetadata: await actions.createData(
