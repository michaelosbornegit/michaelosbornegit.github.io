...
What I use [Home Assistant](https://www.home-assistant.io/) for. Hint: you can use it for way more than just home automation. By the end of this article you will hopefully be convinced to give it a try.
