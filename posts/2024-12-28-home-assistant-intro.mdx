---
slug: home-assistant
title: 🏠 You (might) NEED Home Assistant
...
<img src="/img/ha-home-presence-history.png" alt="home presence tracking dashboard" />
...
<img src="/img/ha-tv-control.jpeg" alt="tv control dashboard" />
...
<img src="/img/ha-dog-tracker.png" alt="dog dashboard" />
<figcaption style={{ textAlign: 'center' }}>*Dog Dashboard*</figcaption>
</figure>
<figure style={{ width: '30%' }}>
<img src="/img/door-dog-tracker-device.jpg" alt="doorway dog tracker device" />
<figcaption style={{ textAlign: 'center' }}>*Doorway dog tracker device*</figcaption>
</figure>
<figure style={{ width: '30%' }}>
<img src="/img/my-desk-dog-tracker-device.jpg" alt="my desk dog tracker device" />
<figcaption style={{ textAlign: 'center' }}>*My desk*</figcaption>
</figure>
<figure style={{ width: '30%' }}>
<img src="/img/katrina-desk-dog-tracker-device.jpg" alt="girlfriends desk dog tracker device" />
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
<figure style={{ width: '50%' }}>
<img src="/img/ha-energy-drink-tracker.png" alt="energy drink dashboard" />
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
<figure style={{ width: '50%' }}>
<img src="/img/ha-exercise.png" alt="exercise dashboard" />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
<figure style={{ width: '30%' }}>
<img src="/img/ha-mike-room-temp.png" alt="room temp dashboard" />
<figcaption style={{ textAlign: 'center' }}>*Room temp/CO2/humidity dashboard*</figcaption>
</figure>
<figure style={{ width: '30%' }}>
<img src="/img/ha-mike-room-temp-device.jpg" alt="room temp dashboard" />
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
<figure style={{ width: '50%' }}>
<img src="/img/ha-historical-weather-map-tracking.png" alt="historical weather tracking" />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
<figure style={{ width: '30%' }}>
<img src="/img/ha-garmin-connect.png" alt="garmin connect dashboard" />
<figcaption style={{ textAlign: 'center' }}>*Garmin connect dashboard*</figcaption>
</figure>
<figure style={{ width: '30%' }}>
<img src="/img/ha-grafana-health-dashboard.png" alt="grafana health dashboard" />
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
<figure style={{ width: '50%' }}>
<img src="/img/ha-3d-printer-dashboard.png" alt="3d printer dashboard" />
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
<figure style={{ width: '50%' }}>
<img src="/img/ha-helpers.png" alt="helpers view" />
